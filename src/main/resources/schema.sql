-- ============================================================
-- cost-analysis-backend  전체 스키마 (PostgreSQL)
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_quotations_uploader     ON quotations(uploader_id);
CREATE INDEX IF NOT EXISTS idx_quotations_status       ON quotations(status);
CREATE INDEX IF NOT EXISTS idx_quotations_uploaded     ON quotations(uploaded_at DESC);
CREATE INDEX IF NOT EXISTS idx_parsed_items_quot       ON parsed_items(quotation_id);
CREATE INDEX IF NOT EXISTS idx_verify_quot             ON verification_results(quotation_id);
CREATE INDEX IF NOT EXISTS idx_insight_msg_sess        ON insight_messages(session_id);
